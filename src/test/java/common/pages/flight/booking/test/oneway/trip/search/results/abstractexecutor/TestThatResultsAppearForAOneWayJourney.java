package common.pages.flight.booking.test.oneway.trip.search.results.abstractexecutor;
...
public abstract class TestThatResultsAppearForAOneWayJourney extends AbstractWebTest {
  ...
  @Test(priority = 10, description = "fill To location")
